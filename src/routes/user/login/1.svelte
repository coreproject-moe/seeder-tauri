...
>
	<span
		class="flex items-center text-base font-bold uppercase leading-none tracking-widest text-white md:text-[1.2vw]"
	...
	<div class="flex items-center justify-between">
		<div class="flex flex-col gap-1 md:gap-[0.5vw]">
			<span class="text-xs leading-none text-surface-100 md:text-[0.75vw]"
				>Don't have a core account?</span
			>
			<a href="./register" class="text-base leading-none md:text-[1.1vw]"> Register </a>
		</div>
		<button
			type="submit"
